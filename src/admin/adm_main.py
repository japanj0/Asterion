...
class ServerThread(QThread):
    ...
    def handle_client(self, client_socket, username):
        ...
        reader = PacketReader()
        packet_times = []
        ALLOWED_TYPES = {'message', 'screen', 'stop_screen', 'file_start', 'file_chunk', 'file_end', 'file_request'}
        try:
            while self.running:
